...
<head>
    ...
    <script defer src="scriptbaru1.js"></script>
    ...
    <link rel="stylesheet" href="../css/baruxxx.css">
...
<body>
                ...
                <div class="row g-5 mb-5 justify-content-center">
                    <!-- <div class="col-xl-4 col-lg-6 wow fadeIn" data-wow-delay=".3s">
                        <div class="d-flex bg-light p-3 rounded">
                            ...
                            <div class="ms-3">
                                <h4 class="text-primary">1. Tekan Tombol Refresh Dahulu</h4>
                            </div>
                        </div>
                    </div> -->
                    <div class="col-xl-4 col-lg-6 wow fadeIn" data-wow-delay=".3s">
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB_LFJi0xHyDocC0AYR-w595EyVMKDlqIk">
    </script>
</body>
