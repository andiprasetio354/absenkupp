                    ...
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-12">
                            <div class="card-body">
                                ...
                                <div>
                                    <label for="waktu_absen_masuk" class="form-label">Jam Absen Masuk</label>
                                    <input type="time" class="form-control" id="waktuAbsenMasukInput" />
                                </div>
                                <div style="display: none;">
                                    <label for="waktu_absen_keluar" class="form-label">Jam Absen Keluar</label>
                                    <input type="time" class="form-control" id="waktuAbsenKeluarInput" />
                                </div>

                                <div id="absen-message"></div>
                                <button id="ambilAbsenButton" class="btn btn-primary mt-3">Ambil Absen</button>
                            </div>
                        </div>
                    </div>
                </div>
