                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                            <img src="<?php echo $profile_picture_path; ?>" alt="user-avatar" class="d-block rounded" height="100">
                        ...
                        <form method="POST" action="?q=up_data_user">
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control" type="text" id="n_profil" name="n_profil" value="<?php echo $_SESSION['username']; ?>" autofocus />
                                </div>
                                <div class="mb-3 col-md-6">
                                    <div class="form-password-toggle">
                                        <label class="form-label" for="pw_baru">Password Baru</label>
                                        <div class="input-group">
                                            <input type="password" class="form-control" id="pw_baru" name="pw_baru" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="basic-default-password2" />
                                ...
                                <div class="mb-3 col-md-6">
                                    <div class="form-password-toggle">
                                        ...
                                        <div class="input-group">
                                            <input type="password" class="form-control" id="konf_pw_baru" name="konf_pw_baru" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="basic-default-password2" />
                                            <span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
                                        </div>
                                    </div>
                                </div>
