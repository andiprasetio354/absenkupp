...
await fetchLabels();
    ...
    if (response.ok) {
        ...
        // if (responseData.status === 'sudah_absen') {
        //     alert('Anda sudah melakukan absen hari ini. Terima Kasih!');
        //     // Tambahkan logika untuk menampilkan data absensi jika diperlukan
        // } else {
            // Lanjutkan proses absen
    ...
    try {
        ...
        if (response.status === 200) {
            ...
            Swal.fire({
                ...
                text: 'Data absen keluar telah disimpan.',
            ...
            Swal.fire({
                ...
                text: 'Terjadi kesalahan saat menyimpan data absen keluar.',
