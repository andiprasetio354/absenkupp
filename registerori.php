            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- /Logo -->
                        <h4 class="mb-2">Silahkan Daftar </h4>
                        <p class="mb-4">Buat akun barumu dan silahkan masuk</p>

                        <form class="mb-3" action="auth/auth_register" method="POST">
                            <div class="mb-3">
                                <label for="username" class="form-label">Nama Pengguna</label>
                                <input type="text" class="form-control" id="username" name="username"
                                    placeholder="Masukkan nama penggunamu" autofocus />
                            </div>
